...
public class ExcelController {
	...
	public ResponseEntity<ExcelResult> getRouteExcelByDay(@RequestParam(value="day",required=false) String day)
	{
	...
	public ResponseEntity<ExcelResult> getRouteExcelByWeek(@RequestParam(value="day",required=false) String day)
	{
		String[] weekDates = eDao.getWeekStartAndEndDate(day);
	...
	public ResponseEntity<ExcelResult> getRouteExcelByMonth(@RequestParam(value="day",required=false) String day)
	{
		String[] monthDates = eDao.getMonthStartAndEndDate(day);
